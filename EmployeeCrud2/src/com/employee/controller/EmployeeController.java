...
public class EmployeeController extends HttpServlet {
	...
	private void updateEmployee(HttpServletRequest request, HttpServletResponse response)
		...
		Employee emp = new Employee(id, name, age, salary, date1,values);
	...
	private void showEditForm(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(existingemp.getJoiningdate());
		//String date = "2023-12-12";
		Date datew = existingemp.getJoiningdate();
		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd"); 
		String strDate = dateFormat.format(datew); 
	...
	private void insertEmployee(HttpServletRequest request, HttpServletResponse response)
		...
		Date date1=new SimpleDateFormat("yyyy-MM-dd").parse(joiningdate);  
		Employee emp = new Employee(name, age, salary, date1,values);
		System.out.println( );
